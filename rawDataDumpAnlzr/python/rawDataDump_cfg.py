...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(
                                        ...
                                        #"file:/eos/user/r/rkaundal/Rohit/HGCAL_git_nw/HGCAL_DIGIS_project/HGCal_Digis_generalization/CMSSW_16_1_0/src/rawDataProducer_repacked_gen/rawDataProducer_repacked/python/testRawDataBuffer_repacked_eRun_full_manual_passThrough.root"
...
process.TFileService = cms.Service(
    ...
    fileName = cms.string("tmp_CRC_diff_Cal_pRun_1.root")
)

process.dump = cms.EDAnalyzer("rawDataDumpAnlzr",
