...
static constexpr auto s_tag = "[validation_RAW2DIGI]";

TEST_CASE("Standard checks of validation_RAW2DIGI", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("validation_RAW2DIGI"
