...
cmsRun -j FrameworkJobReport_RAW2DIGI.xml \
  ...
  buBaseDirsNumStreams=2 \
  buBaseDirsStreamIDs=1600,1601 \
  overrideRangeLS=1,1 \
  files=${datadir} \
  yamls="{}" \
  output=RAW2DIGI_electronRun_118388.root \
  maxEvents=-1 \
  secondaryOutput=RAW2DIGI_electronRun_118388.root \
  enableTPGunpacker=False
