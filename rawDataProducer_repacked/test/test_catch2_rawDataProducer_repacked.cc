...
static constexpr auto s_tag = "[rawDataProducer_repacked]";

TEST_CASE("Standard checks of rawDataProducer_repacked", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("rawDataProducer_repacked"
