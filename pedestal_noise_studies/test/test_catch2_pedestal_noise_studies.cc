...
static constexpr auto s_tag = "[pedestal_noise_studies]";

TEST_CASE("Standard checks of pedestal_noise_studies", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("pedestal_noise_studies"
